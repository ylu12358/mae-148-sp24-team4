...
# #
AXLE_LENGTH = 0.23     # length of axle; distance between left and right wheels in meters
WHEEL_BASE = 0.33       # distance between front and back wheels in meters
WHEEL_RADIUS = 0.049  # radius of wheel in meters
...
VESC_MAX_SPEED_PERCENT = 0.25  # Max speed as a percent of the actual speed
...
VESC_STEERING_SCALE= 0.3 # VESC accepts steering inputs from 0 to 1. Joystick is usually -1 to 1. This changes it to -0.5 to 0.5
...
# # PATH FOLLOWING
# #
PATH_FILENAME = "sortbotpathcompare.csv"   # the path will be saved to this filename as comma separated x,y values
#PATH_FILENAME = "sbmanual.csv"
PATH_DEBUG = False                   # True to log x,y position
PATH_SCALE = 6.0                   # the path display will be scaled by this factor in the web page
...
PATH_SEARCH_LENGTH = 5           # number of points to search for closest point, None to search entire path
...
PID_P = 0.13                        # proportional mult for PID path follower
PID_I = 0.000                       # integral mult for PID path follower
PID_D = 0.4                      # differential mult for PID path follower
...
# #
SAVE_PATH_BTN = "L1"        # button to save path
LOAD_PATH_BTN = "smth"             # button (re)load path
RESET_ORIGIN_BTN = "R1"     # button to press to move car back to origin
ERASE_PATH_BTN = "smth"     # button to erase path

#SAVE_PATH_BTN = "smth"        # button to save path
#LOAD_PATH_BTN = "L1"             # button (re)load path
#RESET_ORIGIN_BTN = "R1"     # button to press to move car back to origin
#ERASE_PATH_BTN = "smth"     # button to erase path


TOGGLE_RECORDING_BTN = "option" # button to toggle recording mode
INC_PID_D_BTN = "right"            # button to change PID 'D' constant by PID_D_DELTA
DEC_PID_D_BTN = "left"            # button to change PID 'D' constant by -PID_D_DELTA
INC_PID_P_BTN = "Y"            # button to change PID 'P' constant by PID_P_DELTA
DEC_PID_P_BTN = "X"            # button to change PID 'P' constant by -PID_P_DELTA
# 
